...
def convert_parser(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('-dest_pattern',  type = str, default = 'corpus.{id:02}.jsonl', help = 'The format of the JSON file name')
    parser.add_argument('-count', type = int, default = 500000, help = 'The number of JATS files in a single JSON file')
